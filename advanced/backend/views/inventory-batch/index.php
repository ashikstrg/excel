...
?>
<div class="inventory-batch-index">
    ...
    $gridColumns = [
        ...
        [
            ...
            'vAlign' => 'middle',
            'value'=>function ($data) {
                    return Html::a('<i class="fa fa-search"></i>', ['/inventory/index', 'InventorySearch[batch]' => $data->batch]);
            },
        ],
        [
...
<div class="box-footer">
    <div class="row">
        <div class="col-md-12">
            <i>* Inventory Files are listed in descending order.</i>
        </div>
    </div>
</div>
