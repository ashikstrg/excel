...
$this->subTitle = 'Uploaded Sales Data';
...
<div class="sales-batch-index">
    ...
    $gridColumns = [
		...
		'format' => 'raw',
                ...
                'vAlign' => 'middle',
		'value'=>function ($data) {
			return Html::a('<i class="fa fa-search"></i>', ['/sales/index', 'SalesSearch', 'batch' => $data->batch]);
		},
            ],
            'status',
            'created_by',
    ...
    <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading'=> '<i class="glyphicon glyphicon-book"></i> List of Uploaded Sales Data',
...
<div class="box-footer">
    <div class="row">
        <div class="col-md-12">
            <i>* Sales Files are linked to the main sales data.</i>
        </div>
    </div>
</div>
