...
$this->title = 'FSM Data Upload Detail';
$this->miniTitle = 'HR Module';
$this->subTitle = 'Batch Number: ' . $model->batch;
$this->params['breadcrumbs'][] = ['label' => 'HR (FSM) Active Batch Data', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="hr-batch-view">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                if( Yii::$app->session->get('userRole') == 'admin' ) {
                    ...
                    echo Html::a('Add New', ['/hr/create'], ['class' => 'btn btn-primary']);
                    echo ' ';
                    echo Html::a('Configure', ['/hr/index'], ['class' => 'btn btn-primary']);
