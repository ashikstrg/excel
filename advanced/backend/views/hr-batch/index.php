...
$this->subTitle = 'List of Active HR Batch Data';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="hr-batch-index">
    ...
    $gridColumns = [
        ...
        [
            ...
            'vAlign' => 'middle',
            'value'=>function ($data) {
                return Html::a('<i class="fa fa-search"></i>', ['/hr/index', 'HrSearch[batch]' => $data->batch]);
            },
        ], //2
    ...
    <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading'=> '<i class="glyphicon glyphicon-book"></i> List of Hr Batch File in Descending Order',
...
<div class="box-footer">
    <div class="row">
        <div class="col-md-12">
            <i>* HR Files are linked to the main data. Be careful before delete.</i>
        </div>
    </div>
</div>
