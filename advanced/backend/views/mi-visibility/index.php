...
$this->title = 'MI Visibility Congiguration';
$this->miniTitle = 'MI Module';
$this->subTitle = 'Visibility Data';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="mi-visibility-index">
    ...
    <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading'=> '<i class="glyphicon glyphicon-book"></i> List of MI Visibility List',
