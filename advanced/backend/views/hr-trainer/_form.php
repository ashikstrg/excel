...
<div class="hr-trainer-form">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <?= $form->field($model, 'manager_id')->widget(DepDrop::classname(), [
                ...
                'pluginOptions'=>[
                    'depends'=>['hrtrainer-designation_id'],
                    'placeholder'=>'Select Manager',
                    'url'=>Url::to(['/hr-trainer/find_manager'])
                ]
            ]); ?>
    ...
    <div class="box-footer">
        <div class="row">
            <div class="col-md-6">
                <?= Html::submitButton($model->isNewRecord ? 'Add HR (Trainer)' : 'Update HR (Trainer)', ['class' => 'btn btn-primary']) ?>
            </div>
            <div class="col-md-6">
