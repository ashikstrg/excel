...
$this->title = 'Travel Application Satus';
$this->miniTitle = 'Travel Module';
$this->subTitle = 'Your Application';
...
<div class="travel-index">
    ...
    <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading'=> '<i class="glyphicon glyphicon-book"></i> List of your application in terms of travel approval'
            ],
        ]); ?>
    <?php Pjax::end(); ?>
