...
<div class="hr-form">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <?= $form->field($model, 'tm_employee_id')->widget(DepDrop::classname(), [
                'options'=>['placeholder'=>'At First Select Designation'],
                'data'=>[$model->tm_employee_id => $model->tm_employee_id . ' - ' . $model->tm_name],
                'pluginOptions'=>[
                    'depends'=>['hr-designation_id'],
    ...
    <div class="box-footer">
        <div class="row">
            <div class="col-md-6">
                <?= Html::submitButton($model->isNewRecord ? 'Add HR (FSM)' : 'Update HR (FSM)', ['class' => 'btn btn-primary']) ?>
            </div>
            <div class="col-md-6">
