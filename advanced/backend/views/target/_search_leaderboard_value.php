    ...
    <div class="row">
        <div class="col-md-8">
            ...
            if(!Yii::$app->session->get('isTM') && !Yii::$app->session->get('isAM')) {
                echo Html::a('<i class="glyphicon glyphicon-group"></i> AM wise Leaderboard', ['leaderboard_value_am'], ['class' => 'btn btn-primary', 'title'=> 'Refresh']); 
            } else {
                echo '&nbsp;';
            }
            ...
            if (Yii::$app->session->get('userRole') == 'Management') {
                echo Html::a('<i class="glyphicon glyphicon-group"></i> CSM wise Leaderboard', ['leaderboard_value_csm'], ['class' => 'btn btn-primary', 'title' => 'Refresh']);
            } else {
                echo '&nbsp;';
            }
