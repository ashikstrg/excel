...
$this->title = 'CSM wise Leaderboard by Volume';
...
<div class="target-leaderboard">
    ...
    <?php echo $this->render('_search_leaderboard_csm', ['model' => $searchModel]); ?>
    ...
    <?= GridView::widget([
            ...
            'toolbar' =>  [
                ...
                $fullExportMenu,
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['leaderboard_csm'], ['class' => 'btn btn-warning', 'title'=> 'Refresh'])
                ],
            ],
