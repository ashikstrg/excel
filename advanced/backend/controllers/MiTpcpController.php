...
use backend\models\MiTpcpSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

class MiTpcpController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if($model->save()) {
                Yii::$app->session->setFlash('success', 'MI TP&CP has successfully been added.');            
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', 'MI TP&CP has successfully been updated.');     
            return $this->redirect(['view', 'id' => $model->id]);
        } else {
    ...
    public function actionMdelete()
    {
        ...
        {
            $sql = "DELETE FROM mi_tpcp WHERE id = $value";
    ...
    {
        if (($model = MiTpcp::findOne($id)) !== null) {
            return $model;
        } else {
