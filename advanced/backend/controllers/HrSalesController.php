...
use backend\models\HrSalesSearch;
...
class HrSalesController extends Controller
{
    public static $employeeTypeId = 2;
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            if ($model->save()) { 
                ...
                Yii::$app->session->setFlash('success', 'HR (Sales) has successfully been added.');
    ...
    public function actionMdelete()
    {
        ...
        {
            $sql = "DELETE FROM hr_sales WHERE id = $value";
    ...
    {
        if (($model = HrSales::findOne($id)) !== null) {
            return $model;
        } else {
