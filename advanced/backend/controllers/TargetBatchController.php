                                        ...
                                        if(isset($employeeModelCode[$hrEmployeeID][$productModelCode])) {
                                            ...
                                            if($targetModelEntry === null) {
                                                ...
                                                $bulkInsertArray[]=[
                                                    ...
                                                    'tm_vol' => $targetVolume,
                                                    'tm_val' => $targetValue,
                                                    'tm_vol_sales' => $sales['fsm_vol'],
                                                    'tm_val_sales' => $sales['fsm_val'],
                                                    'am_parent' => $amParent,
                                                    'am_employee_id' => $hr->am_employee_id,
                                                    'am_name' => $hr->am_name,
                                                    'am_vol' => $targetVolume,
                                                    'am_val' => $targetValue,
                                                    'am_vol_sales' => $sales['fsm_vol'],
                                                    'am_val_sales' => $sales['fsm_val'],
                                                    'csm_parent' => $csmParent,
                                                    'csm_employee_id' => $hr->csm_employee_id,
                                                    'csm_name' => $hr->csm_name,
                                                    'csm_vol' => $targetVolume,
                                                    'csm_val' => $targetValue,
                                                    'csm_vol_sales' => $sales['fsm_vol'],
                                                    'csm_val_sales' => $sales['fsm_val'],
